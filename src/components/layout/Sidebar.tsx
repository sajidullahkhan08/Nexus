...
import {
  ...
  Bell, FileText, Settings, HelpCircle, ChevronLeft, ChevronRight
} from 'lucide-react';
...
const SidebarItem: React.FC<SidebarItemProps> = ({ to, icon, text, collapsed = false }) => {
  return (
    <NavLink
      to={to}
      className={({ isActive }) =>
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className={`${isCollapsed ? 'w-16' : 'w-64'} bg-white h-full border-r border-gray-200 transition-all duration-300 hidden md:block`}>
